  ...
  return (
    <nav className="h-20 flex border-b justify-between font-medium bg-white">
      <Link href="/" className="flex items-center pl-6">
        <span className={cn("text-5xl font-semibold", poppins.className)}>MT Ecommerce</span>
      </Link>
      ...
      <div className="hidden lg:flex">
        ...
        <Link href="/sign-up">
          <Button
            asChild
            className="bg-black border-l border-r-0 border-t-0 border-b-0 rounded-none h-full text-white hover:bg-pink-400 hover:text-black transition-all px-12"
          >
            Start Selling
          </Button>
        </Link>
